...
namespace PowerBi_Embedded_Net_Core_5___Angular
{
    public class Startup
    {
        ...
        {
            // Registro AadService y PbiEmbedService para injección de dependencias.
            services.AddScoped(typeof(AadService))
                    .AddScoped(typeof(PbiEmbedService));

            services.AddControllersWithViews();

            // Carga de configuraciones desde appsettings.json en C# las clases Modelo.
